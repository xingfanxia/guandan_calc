...
export const ACHIEVEMENTS = Object.freeze({
  ...
  streak_3: { name: '状态启动', tier: 'bronze', badgeKey: 'streak_3', desc: '生涯最长通关连胜达到 3 场' },
  ...
  streak_5: { name: '五连制霸', tier: 'silver', badgeKey: 'streak_5', desc: '生涯最长通关连胜达到 5 场' },
  ...
  streak_8: { name: '八连无人区', tier: 'gold', badgeKey: 'streak_8', desc: '生涯最长通关连胜达到 8 场' },
...
function baseProgress(playerStats = {}) {
  ...
  return [
    ...
    { id: 'streak_3', unlocked: m.streak >= 3,
    ...
    { id: 'streak_5', unlocked: m.streak >= 5,
    ...
    { id: 'streak_8', unlocked: m.streak >= 8,
