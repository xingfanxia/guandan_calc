// Capture Linear theme — same populated state as Broadcast capture, but
// switches data-theme="linear" before screenshotting.
...
// Seed history + stats + ranking — same as Broadcast capture
