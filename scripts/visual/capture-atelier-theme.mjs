...
// but boots into data-theme="atelier" before screenshotting.
//
// Outputs full-page + per-section captures to docs/reports/phase3-atelier/.
...
await page.evaluate(() => { localStorage.setItem('gd_v9_theme', 'atelier'); });
...
await page.waitForTimeout(300);
await page.screenshot({
  path: path.join(REPORT_DIR, 'index-atelier-mobile.png'),
  fullPage: true
});
{
