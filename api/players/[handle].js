  ...
  try {
    ...
    if (request.method === 'GET') {
      ...
      if (!isVoteOnly) {
        ...
        // WEB LADDER FREEZE · 2026-08-10 (D5)
        // Web 与小程序的评分人口/数据源不互通。旧版 web rating/peak/sessions/
        // ladderHistory 从此只作历史留档；正常战绩继续入库，但任何路径都不得再写天梯。
        // wxapp 的两级 PL 是唯一后续权威，且不会从这里的旧分继续累加。
